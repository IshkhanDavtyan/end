...
export default class Field extends Component {
    ...
    fieldParams = ["field name", "type", "required", "payman", "errorMessage"]
    ...
    render() {
        ...
        for (let i = 0; i < this.props.count; i++) {
            field.push(
                <div>
                    ...
                    <div>
                        <p>Validation</p>
                        <p>if <input type="text" className="payman" /> error message <input type="text" className="error" /> </p>
                    </div>
        ...
        return (
            <div>
                <div className="form-group">
                        <label for="exampleFormControlInput1" >Model's name</label>
                        <input type="text" className="form-control modelsName" />
                        <hr style={{border:"5px solid"}}/>
